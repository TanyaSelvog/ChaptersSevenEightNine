...
/**
This program demonstrates a 2-dimensional array.
The array has 3 rows (one for each division of the company)
and 4 columns (one for each quarter).
*/
...
public class CorpSales
{
    public static void main(String[] args)
    {
        ...
        // sales figure for each division
