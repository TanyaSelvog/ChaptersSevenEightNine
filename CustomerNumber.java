...
verify that is in the proper format.
*/
...
public class CustomerNumber
{
    public static void main(String[] args)
    {
        ...
        if (isValid(input))
        {
            ...
            "That is a valid customer number.");
        }
        else
        {
            JOptionPane.showMessageDialog(null,
    ...
    /**
    The isValid method determines whether a String
    is a valid customer number. If so, it returns true
    ...
    */
    ...
    private static boolean isValid(String custNumber)
    {
        ...
        // Test the first 3 characters for letters
        while (goodSoFar && i < 3)
        {
        ...
        // Test the last 4 characters for digits
        while (goodSoFar && i < 7)
        {
